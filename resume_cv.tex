...
\getenv[\cvemail]{CVEMAIL}
\getenv[\cvhomepage]{CVHOMEPAGE}
...
\makecvfooter{\today}{}{Philippos Gorgoris~~~·~~~Curriculum Vitae} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
