...
% Read environment variables to hide sensitive information
\ExplSyntaxOn
...
\getenv[\cvphone]{CVPHONE}
\getenv[\cvaddress]{CVADDRESS}
\getenv[\cvdateofbirth]{CVDATEOFBIRTH}

% Available options: circle|rectangle,edge/noedge,left/right
\photo[circle,noedge,left]{./graphics/profile.jpg}
\name{DI}{Philippos Gorgoris}
\position{Softwareentwickler mit Schwerpunkt Java/Spring}
\address{\cvaddress}
\mobile{\cvphone}
\dateofbirth{\cvdateofbirth}

\email{philipgorgoris@gmail.com}
\homepage{www.gorgoris.com}
\github{metagon}
%\linkedin{posquit0}
%\skype{skypeid}
...
\makecvfooter{\today}{}{Dipl.-Ing. Philippos Gorgoris~~~·~~~Lebenslauf} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed

%----------------------------------------------------------------------------------------

\begin{document}

\makecvheader[C] % Print the header
