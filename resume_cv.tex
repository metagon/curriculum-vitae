...
\name{Philippos}{Gorgoris}
\position{Software Engineer}
\address{\cvaddress}
\mobile{\cvphone}

\email{philippos@gorgoris.com}
...
\makecvfooter{\today}{}{Philippos Gorgoris, MSc~~~·~~~Curriculum Vitae} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
